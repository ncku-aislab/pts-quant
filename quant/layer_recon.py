...
def layer_reconstruction(model: QuantModel, fp_model: QuantModel, layer: QuantModule, fp_layer: QuantModule,
    ...
    if pts_mode == 'learned_hard_sigmoid':
        ws_para += [layer.weight_quantizer.pts_alpha]
    ...
    for i in range(iters):
        if i == scale_iter:
            layer.weight_quantizer.convert_scale()
    ...
    layer.weight_quantizer.pts_soft_targets = False
    layer.act_quantizer.pts_soft_targets = False
